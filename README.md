...
const $userRepository = provide("userRepository")
    .using($databaseClient)
    .by(createUserRepository)
const $sessionRepository = provide("sessionRepository")
    .using($databaseClient)
    .by(createSessionRepository)
const $messageRepository = provide("messageRepository")
    .using($databaseClient)
    .by(createMessageRepository)
const $roomRepository = provide("roomRepository")
    .using($databaseClient)
    .by(createChatRepository)
...
- `opts`: Optional configuration object:
    - `dependencies`: An array of dependency providers.
...
This is free and open source project licensed under the [MIT License](LICENSE). You could help its development by contributing via [pull requests](https://github.com/ncor/context-resolver/fork) or [submitting an issue](https://github.com/better-auth/better-auth/issues).
